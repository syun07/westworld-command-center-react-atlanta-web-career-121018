        ...
        <Grid.Column width={10}>
          <Card>
            <Card.Content>
              ...
              <Card.Meta>
                  {this.props.host.active ?
                      <Radio label={"Active"} checked={true} onChange={this.toggle(this.props.host)} slider /> :
                      <Radio label={"Decomissioned"} checked={false} onChange={this.toggle(this.props.host)} slider />}
              </Card.Meta>

              <Divider />
              Current Area: {this.props.host.area}
              {/* <Dropdown
